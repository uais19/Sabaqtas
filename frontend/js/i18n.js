...
const TRANSLATIONS = {
  kk: {
    ...
    "landing.heroSubtitle": "Есеп шықпай ма? Әдетте себебі бұрын өтілген тақырыпта. Sabaqtas оны тауып, түсінуге көмектеседі.",
    "landing.heroButton": "Оқуды бастау",
    "landing.problemTitle": "Мәселе",
    "landing.problem1": "Репетитор бәрінде бола бермейді",
    "landing.problem1text": "Ауылда сабақтан кейін түсіндіретін адам табу қиын.",
    "landing.problem2": "Мұғалім бәріне бір",
    "landing.problem2text": "Мұғалім сыныптағы әр оқушыға жеке уақыт бөле алмайды.",
    "landing.problem3": "ЖИ оқушының орнына шешіп береді",
    "landing.problem3text": "Сондықтан көп мектепте оған тыйым салынған.",
    "landing.solutionTitle": "Шешім",
    "landing.solutionText": "Sabaqtas оқушы түсінбеген тақырыпты тауып, оны жауапқа нұсқаулармен жетелейді. Барлық түсіндірме мектеп оқулығынан алынады.",
    ...
    "landing.gapHere": "← осында олқылық",
    ...
    "landing.diffTitle": "Айырмашылығымыз неде",
    ...
    "landing.diff2text": "ЖИ дайын жауап бермейді. Ол сұрақ қойып, шешімге өзің жетуіңе көмектеседі. Сондықтан оны мектепте қолдануға болады.",
    "landing.diff3": "Тек оқулықтан",
    ...
    "landing.teachersText": "Кім қай жерде тұрып қалғаны және кімге көмек керегі көрініп тұрады. Дәптер тексерудің қажеті жоқ.",
