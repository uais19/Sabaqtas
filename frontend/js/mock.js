...
// Ученик ошибается на первых трёх вопросах и отвечает верно на четвёртом,
// поэтому корневой пробел — "Действия с дробями, 6 класс".

const MOCK = {

  // Начало диагностики: первый вопрос по теме текущего класса.
  diagnosticStart: {
    diagnostic_id: "diag_1001",
    question: {
      id: "q_9_kv_01",
      text: "Найдите корни уравнения x² − 5x + 6 = 0",
      options: ["x = 2 и x = 3", "x = −2 и x = −3", "x = 1 и x = 6", "x = 5 и x = 6"],
      topic_title: "Квадратные уравнения",
      grade: 9
    }
  },

  // Ответы на вопросы диагностики — по порядку.
  // Каждый элемент массива — это ответ бэкенда на очередной ответ ученика.
  diagnosticAnswer: [

    // 1. Ошибка на теме 9 класса -> спускаемся к пререквизиту (7 класс).
    {
      is_correct: false,
      status: "continue",
      question: {
    ...
    // 2. Ошибка на теме 7 класса -> спускаемся к пререквизиту (6 класс).
    {
      is_correct: false,
      status: "continue",
      question: {
    ...
    // 3. Ошибка на теме 6 класса -> спускаемся к пререквизиту (5 класс).
    {
      is_correct: false,
      status: "continue",
      question: {
    ...
    // 4. Верный ответ на теме 5 класса -> дно цепочки найдено, диагностика окончена.
    // Корневой пробел — самая нижняя тема, где была ошибка (6 класс).
    {
      is_correct: true,
      status: "finished",
      result: {
        ...
        path: [
          { topic_id: "t_9_kvadr", title: "Квадратные уравнения", grade: 9, is_correct: false },
          { topic_id: "t_7_fsu", title: "Формулы сокращённого умножения", grade: 7, is_correct: false },
          { topic_id: "t_6_drobi", title: "Действия с дробями", grade: 6, is_correct: false },
          { topic_id: "t_5_umn", title: "Умножение и деление", grade: 5, is_correct: true }
        ],
        weak_topics: [
          { topic_id: "t_6_drobi", title: "Действия с дробями", grade: 6 },
          { topic_id: "t_7_fsu", title: "Формулы сокращённого умножения", grade: 7 },
          { topic_id: "t_9_kvadr", title: "Квадратные уравнения", grade: 9 }
        ]
      }
    }
  ],
